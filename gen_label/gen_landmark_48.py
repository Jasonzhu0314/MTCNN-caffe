...
dstdir = "/lfs1/users/szhu/project/MTCNN-keras/data4/48/landmark"
OUTPUT = '/lfs1/users/szhu/project/MTCNN-keras/data4/48'
    ...
    for (imgPath, bbox, landmarkGt) in data:
        ...
        if argument:  # 数据增强
            ...
            for i in range(len(F_imgs)):
                ...
                sys.stdout.write("\r"+'traindata_num:'+str(image_id) + "\t\t\t")
                sys.stdout.flush()
...
if __name__ == '__main__':
    ...
    net = "ONet"
    #train_txt = "train.txt"
    train_txt = "/lfs1/users/szhu/project/MTCNN-keras/data/train_labels.txt"
