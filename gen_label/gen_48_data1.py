        ...
        if numbox > 0:
            ...
            for k in range(numbox):
                ...
                try:
                    ...
                    resized_img =cv2.resize(tmp, (48, 48), interpolation=cv2.INTER_LINEAR)
...
r_model= PNet.RNet()
r_model.load_weights('/lfs1/users/szhu/project/MTCNN-keras/model/real_accuracy/r0.001-1-01.h5')
